...
def repeat_job_match(base_url, time, e_phone, l_phone, work_date, start_time, work_hour, custom_name):
    """多人媒合多個工單"""
    e_phone = int(e_phone)
    l_phone = int(l_phone)
    time = int(time)
    ...
    try:
        ...
        return job_sn_list, {"status": "pass", "msg": "媒合成功"}  # 返回所有工單編號
...
if __name__ == "__main__":
    ...
    repeat_job_match(BASE_URL,TIME, E_PHONE, L_PHONE, WORK_DATE, START_TIME, WORK_HOUR, CUSTOM_NAME)
